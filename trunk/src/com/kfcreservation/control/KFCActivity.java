...
import com.example.kfcreservation.R;
import com.kfcreservation.view.pager1;
import com.kfcreservation.view.pager2;
import com.kfcreservation.view.pager3;
...
public class KFCActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.addTab(mTabHost.newTabSpec("A").setIndicator(tabIndicator1)
				.setContent(i1));
		mTabHost.addTab(mTabHost.newTabSpec("B").setContent(i2)
				.setIndicator(tabIndicator2));
		mTabHost.addTab(mTabHost.newTabSpec("C").setContent(i3)
