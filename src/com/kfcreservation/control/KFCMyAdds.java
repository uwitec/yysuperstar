...
public class KFCMyAdds extends Activity {
	...
	private  ListView lv_phone,lv_addresses;
	...
	protected void onStart() {
		...
		super.onStart();
		lv_phone.setAdapter(getAdapter());
	...
	public void getValues(){
		lv_phone.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				HashMap<String,Object> mp =(HashMap<String,Object>)parent.getItemAtPosition(position);
				String phonenumber =(String)mp.get("PhoneNum");
				System.out.println("jjjjjjjj"+phonenumber);
				tv_selectphone.setText(phonenumber);				
	...
	public SimpleAdapter getAddressAdapter(){
		...
		SimpleAdapter adapter =new SimpleAdapter(this,ls,R.layout.addaddress,from,to);
		return adapter;
	}
	//联系方式中的adapter
	...
	class btnClick implements OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.btn_newPhone:
				...
				final View view =inflater.inflate(R.layout.myadds_add_dialogphone, null);
			...
			case R.id.btn_newAddress:
				getToast("添加地址");
				AlertDialog.Builder builder2 =new AlertDialog.Builder(KFCMyAdds.this);
				LayoutInflater inflater2 = LayoutInflater.from(KFCMyAdds.this);
				final View view2 =inflater2.inflate(R.layout.myadds_add_address, null);
				final Spinner spzong =(Spinner)view2.findViewById(R.id.sp_zone);
				final EditText newaddress =(EditText)view2.findViewById(R.id.et_daddress);
				builder2.setView(view2);
				builder2.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						String zong =spzong.getSelectedItem().toString().trim();
						String road =newaddress.getText().toString().trim();
